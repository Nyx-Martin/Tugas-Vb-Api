...
Public Class Form1
    ...
    Private Sub UpdateData()
        Try
            ...
            Dim uriString As String = "http://localhost/code_in/index.php/Api/PutData/" & txt_npm.Text.Trim & "/" & txt_nama.Text.Trim & "/" & txt_jurusan.Text.Trim & "/" & txt_prodi.Text.Trim & "/" & txt_kelas.Text.Trim
    ...
    Private Sub HapusData()
        Try
            DataGridView1.Rows.Clear()
            Dim uriString As String = "http://localhost/code_in/index.php/Api/DeleteData/" & txt_npm.Text.Trim & "/" & txt_nama.Text.Trim & "/" & txt_jurusan.Text.Trim & "/" & txt_prodi.Text.Trim & "/" & txt_kelas.Text.Trim
            Dim uri As New Uri(uriString)
            Dim request As HttpWebRequest = HttpWebRequest.Create(uri)
    ...
    Private Sub tambahdata()
        Try
            DataGridView1.Rows.Clear()
            Dim uriString As String = "http://localhost/code_in/index.php/Api/PostData/" & txt_npm.Text.Trim & "/" & txt_nama.Text.Trim & "/" & txt_jurusan.Text.Trim & "/" & txt_prodi.Text.Trim & "/" & txt_kelas.Text.Trim
            Dim uri As New Uri(uriString)
            Dim request As HttpWebRequest = HttpWebRequest.Create(uri)
            request.Method = "POST"
            Dim response As HttpWebResponse = request.GetResponse()
    ...
    Private Sub carinama()
        Try
            DataGridView1.Rows.Clear()
            Dim uriString As String = "http://localhost/code_in/index.php/Api/SearchData/" & TextBox1.Text.Trim
            Dim uri As New Uri(uriString)
            Dim request As HttpWebRequest = HttpWebRequest.Create(uri)
            request.Method = "GET"
            Dim response As HttpWebResponse = request.GetResponse()
